...
#define MAX_HISTO_BINS 512
    ...
    typedef struct   {
        ...
        float backAlpha; //final alpha of the advanced render, 0..1 (default 0.95); <= 0 keeps the default
        float volumeOpacity; //per-sample opacity scale of the advanced MR render, 0..1 (default 1 = as authored); <= 0 keeps the default
